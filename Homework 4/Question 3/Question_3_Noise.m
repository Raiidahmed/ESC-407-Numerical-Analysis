%Raiid Ahmed Homework 4 Question 3 Noisy Data

format long
clc
clear

load('projectile_data_noise.csv')

projectile_noise = projectile_data_noise;
x = projectile_noise(:,2).';
y = projectile_noise(:,3).';
time = projectile_noise(:,1).';
